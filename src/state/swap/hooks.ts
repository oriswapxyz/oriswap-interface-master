...
const BAD_RECIPIENT_ADDRESSES: string[] = [
  '0xBE29C8787A032F80B66B1b280F82eCc5870D0aCC', // v2 factory
  // '0xf164fC0Ec4E93095b804a4795bBe1e041497b92a', // v2 router 01
  '0x167Afe2189F72403610D6d8338107664C48ea7B6' // v2 router 02
]
...
export function useDerivedSwapInfo(): {
  ...
  const { symbol: inSymbol } = useGetSymbol(chainId, amountIn?.currency)

  if (balanceIn && amountIn && balanceIn.lessThan(amountIn)) {
    inputError = 'Insufficient ' + inSymbol + ' balance'
  }
