...
export default function DelegateModal({ isOpen, onDismiss, title }: VoteModalProps) {
  ...
  const uniBalance = useTokenBalance(account ?? undefined, chainId ? DOG[chainId] : undefined)
      ...
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          <AutoColumn gap="lg" justify="center">
            ...
            <TYPE.body>Earned DOG tokens represent voting shares in DogeSwapgovernance.</TYPE.body>
            <TYPE.body>
