...
import { calculateGasMargin, getRouterContract, isAddress, isETFChain, shortenAddress } from '../utils'
      ...
      callback: async function onSwap(): Promise<string> {
        ...
        return contract[methodName](...args, {
          ...
          .then((response: any) => {
            ...
            let inputName = trade.inputAmount.currency.name
            let outputSymbol = trade.outputAmount.currency.symbol
            let outputName = trade.outputAmount.currency.name

            // if (isHecoChain(chainId) && inputSymbol === 'ETH' && inputName === 'Ether') {
            //   inputSymbol = 'HT'
            // }
