...
export default function MigrateV1() {
  ...
  const V1LiquidityTokens: Token[] = useMemo(() => {
    return chainId
      ? Object.keys(V1Exchanges).map(exchangeAddress => new Token(chainId, exchangeAddress, 18, 'DOG-V1', 'DogeSwapV1'))
      : []
  }, [chainId, V1Exchanges])
    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        ...
        <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
          For each pool shown below, click migrate to remove your liquidity from DogeSwapV1 and deposit it into
          DogeSwapV2.
        </TYPE.body>
