...
import { calculateGasMargin, calculateSlippageAmount, getRouterContract, isETFChain } from '../../utils'
...
export default function RemoveLiquidity({
  ...
  async function onAttemptToApprove() {
    ...
    library
      .send('eth_signTypedData_v2', [account, data])
      // .send('eth_signTypedData_v4', [account, data])   签名方式 错误，使用授权
      .then(splitSignature)
      .then(signature => {
        setSignatureData({
          v: signature.v,
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          ...
                          >
                            Receive {chainId && isETFChain(chainId) ? 'WETH' : 'WETH'}
                          </StyledInternalLink>
                        ) : oneCurrencyIsWETH ? (
                          <StyledInternalLink
                            to={`/remove/${
